...
#comando %d imprime un entero
print '"%5d"' % i      # field of width 5 characters
#imprime 5 enteros
print '"%05d"' % i     # pad with zeros
#imprime 5 digitos enteros con ceros a la izquierda
print '"%g"' % r       # r is big number so this is scientific notation
# comando para imprimir un número "r" muy grande en notacion scientifica
print '"%G"' % r       # E in the exponent
#comando para imprimir Een el exponente
print '"%e"' % r       # compact scientific notation
#comando para imprimir notación scientifica compacta
print '"%E"' % r       # compact scientific notation
#comando para imprimir notación scientifica compacta
print '"%20.2E"' % r   # 2 decimals, field of width 20
#commando para que se vean 2 decimales y se sigan hasta 20
print '"%30g"' % r     # field of width 30 (right-adjusted)
#comando para dejar 30 espacios  
